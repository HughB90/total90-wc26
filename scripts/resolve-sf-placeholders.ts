/**
 * SF preparation: resolve every "Winner MX" placeholder in
 * predictor_matches (round_code=sf) to the actual advancing team.
 *
 * Walks QF matches, determines winners (using pk_winner_team_code when
 * went_to_pks). Rewrites SF rows' home_team_code / away_team_code.
 *
 * Adapted from resolve-qf-placeholders.ts.
 */
...
;(async () => {
  ...
  console.log(`resolved QF winners: ${winners.size}/4`)
